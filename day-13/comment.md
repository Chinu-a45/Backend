1. login api generate kiya 
2. protected api kiya
3. password sidha store nahi karte database me warna leak ke time koi bhi kisi ka account access kar lega
4. so we use hashing algorithms , md5 sirf learning ke liye , its not considered secure kyuki collisions hote hai , isliye bcrypt in today world
